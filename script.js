...
const srmBuildings = {
    "Medical Block": [12.823391313620416, 80.04780825170434],
    "Tech Park": [12.824697512364116, 80.04522039919466],
    "Library": [12.823657796962754, 80.04248849029675],
    "Food Court": [12.823374020942719, 80.04449687250127],
    "MBA Block": [12.82367014886474, 80.04414291309796],
    "Main Block": [12.820631881598812, 80.03874059582789]
};
...
async function optimizeCollection() {
    ...
    try {
        const response = await fetch('https://012c-103-197-112-241.ngrok-free.app//optimize', {
            method: 'POST',
            headers: {
